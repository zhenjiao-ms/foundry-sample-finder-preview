// AUTO-GENERATED from data/samples.json by tools/build-data.py. Do not edit by hand.
window.HA_SAMPLES = {
  "meta": {
    "source": "microsoft-foundry/foundry-samples",
    "rootPath": "samples/python/hosted-agents",
    "repoBaseUrl": "https://github.com/microsoft-foundry/foundry-samples/tree/main/samples/python/hosted-agents/",
    "branch": "main",
    "generatedNote": "Catalog built from the verified live folder listing (not only the READMEs). Paths are relative to rootPath; full URL = repoBaseUrl + path.",
    "frameworks": {
      "agent-framework": "Microsoft Agent Framework (also supports AutoGen & Semantic Kernel)",
      "langgraph": "LangGraph / LangChain",
      "bring-your-own": "Bring Your Own (CrewAI, OpenAI Agents SDK, Claude Agent SDK, custom)"
    },
    "sdks": {
      "agent-framework": {
    ...
    "protocols": {
      "responses": "OpenAI-compatible Responses protocol — platform manages history, streaming, background",
      "invocations": "Invocations protocol — arbitrary JSON in/out, custom streaming and sessions",
      "invocations_ws": "Invocations WebSocket protocol — real-time bidirectional audio/voice",
      "a2a": "Agent-to-Agent protocol — delegation between hosted agents",
  ...
  "samples": [
    ...
    },
    {
      ...
      "title": "Declarative Customer Support",
      "framework": "agent-framework",
      "sdk": "agent-framework",
      "protocol": "responses",
      "category": "orchestration",
    ...
    },
    {
      ...
      "title": "Downstream Azure Services",
      "framework": "agent-framework",
      "sdk": "agent-framework",
      "protocol": "responses",
      "category": "production",
    ...
    },
    {
      ...
      "title": "Agent Optimizer: Travel Approver",
      "framework": "agent-framework",
      "sdk": "agent-framework",
      "protocol": "responses",
      "category": "production",
    ...
    },
    {
      ...
      "title": "LangGraph A2A Delegation",
      "framework": "langgraph",
      "sdk": "langgraph",
      "protocol": "a2a",
      "category": "orchestration",
    ...
    },
    {
      ...
      "title": "BYO LangGraph Toolbox (User Identity)",
      "framework": "bring-your-own",
      "sdk": "langgraph",
      "protocol": "responses",
      "category": "tools",
    ...
    },
    {
      ...
      "title": "Agent Optimizer: Hello World",
      "framework": "bring-your-own",
      "sdk": "native",
      "protocol": "responses",
      "category": "production",
    ...
    },
    {
      ...
      "title": "Agent Optimizer: Customer Support",
      "framework": "bring-your-own",
      "sdk": "native",
      "protocol": "responses",
      "category": "production",
    ...
    },
    {
      ...
      "title": "BYO Invocations Hello World",
      "framework": "bring-your-own",
      "sdk": "native",
      "protocol": "invocations",
      "category": "foundations",
    ...
    },
    {
      ...
      "title": "BYO LangGraph Chat (Invocations)",
      "framework": "bring-your-own",
      "sdk": "langgraph",
      "protocol": "invocations",
      "category": "adapters",
    ...
    },
    {
      ...
      "title": "BYO Notetaking (Invocations)",
      "framework": "bring-your-own",
      "sdk": "native",
      "protocol": "invocations",
      "category": "human-async",
    ...
    },
    {
      ...
      "path": "bring-your-own/voicelive/client",
      "description": "A shared Voice Live client (voicelive_client.py) that connects to a deployed Responses agent for a real-time voice conversation. This is a client, not a deployable agent."
    }
  ]
};
